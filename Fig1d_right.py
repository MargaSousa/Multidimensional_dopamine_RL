...
ax.plot_surface(mesh[1], mesh[0], 0 + 0 * joint_pdf_ss, facecolors=scam.to_rgba(joint_pdf_ss), antialiased=True,
...
ax.plot_surface(mesh[1], mesh[0], 0.04 + 0 * joint_pdf_ll, facecolors=scam.to_rgba(joint_pdf_ll), antialiased=True,
                rstride=1, cstride=1, alpha=None)
